...
# Phase 1, Phase 2, Phase 3 결과 출력 및 시각화
print("Phase 1 후 유효한 엣지:", valid_edges_phase1)
print("Phase 2 후 고립된 점 복구:", valid_edges_phase2)
...
def visualize_grouped_points(points, edges, obstacles, title="Grouped Points"):
    ...
    for group in groups:
        ...
        for i in range(len(group)):
            ...
            ax.scatter(points[group[i]][0], points[group[i]][1], color=group_color, s=100)
...
visualize_grouped_points(points, final_edges, obstacles, title="Phase 3 후 그룹화된 포인트")
